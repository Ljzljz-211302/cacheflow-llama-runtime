...
public:
    ...
    ggml_tensor * get_paged_decode_table()  const { return self_paged_decode_table; }
    ggml_tensor * get_paged_decode_length() const { return self_paged_decode_length; }
    ...
    ggml_tensor * self_paged_decode_table  = nullptr;
    ggml_tensor * self_paged_decode_length = nullptr;
...
struct llm_graph_params {
    ...
    bool allow_reuse(const llm_graph_params & other) const {
        ...
        return
            ...
            paged_decode        == other.paged_decode        &&
            arch  == other.arch  &&
            gtype == other.gtype &&
            cvec  == other.cvec  &&
            loras == other.loras &&
...
struct llm_graph_context {
    ...
    ggml_tensor * build_attn_mha(
            ...
            ggml_tensor * v_mla,   // [n_embd_head_v_mla, n_embd_head_v, n_head_v]
                  float   kq_scale,
                    int   il,
            ggml_tensor * paged_decode_table = nullptr,
            ggml_tensor * paged_decode_length = nullptr) const;
