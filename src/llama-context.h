...
struct llama_context {
    ...
    void set_kv_execution_action(enum llama_kv_execution_action action);
    llama_kv_execution_status get_kv_execution_status() const;
...
private:
    ...
    llama_kv_execution_status kv_execution_status {
        LLAMA_KV_EXECUTION_ACTION_DIRECT,
        LLAMA_KV_EXECUTION_ACTION_DIRECT,
        LLAMA_KV_EXECUTION_FALLBACK_NONE,
        0,
        0,
        0,
        0,
    ...
    bool paged_decode_effective = false;
